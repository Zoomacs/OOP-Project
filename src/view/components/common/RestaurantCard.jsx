...
function RestaurantList() {
  ...
  const quickFilters = ["All", "Fast Food", "Pizza", "Fool", "Healthy", "Drinks", "Desserts", "Asian"];
    ...
    <>
      ...
      <div className="restaurant-with-sidebar">
        ...
        <div className="restaurant-main">
          ...
          <div className="quick-filters">{quickFilters.map((filter) => <button key={filter} className={`filter-btn ${activeFilterLabel === filter ? "active" : ""}`} onClick={() => handleQuickFilter(filter)}>{filter}</button>)}</div>
