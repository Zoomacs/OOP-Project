...
function RestaurantDashboard() {
  ...
  useEffect(() => {
    api(`owner-stats&restaurant_id=${restaurantId}`)
      .then((data) =>
        setStats(data.stats || { orders: 0, revenue: 0, items: 0 }),
      )
    ...
    <div className="owner-page-container">
      <div className="owner-header">
        <div>
          ...
          <p className="owner-welcome">
            Welcome back! You are managing restaurant #{restaurantId}.
          </p>
        </div>
      </div>
      ...
      <div className="dashboard-stats">
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            <h3>Revenue</h3>
            <p>{Number(stats.revenue || 0).toFixed(2)} EGP</p>
          </div>
        </div>
        <div className="stat-card">
        ...
        <Link to="/owner/menu" className="owner-nav-card">
          <div className="nav-card-content">
            ...
            <div className="nav-card-text">
              ...
              <p>
                Add images, edit prices, and hide out-of-stock items from
                students.
              </p>
            </div>
          </div>
        ...
        <Link to="/owner/profile" className="owner-nav-card">
          <div className="nav-card-content">
            ...
            <div className="nav-card-text">
              ...
              <p>
                Update your restaurant info or submit a technical support
                ticket.
              </p>
            </div>
          </div>
