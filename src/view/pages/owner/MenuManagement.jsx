...
function getOwnerRestaurantId() {
  const user = getUser();
  return Number(
    user?.restaurant_id || sessionStorage.getItem("restaurantId") || 1,
  );
}
...
function MenuManagement() {
  ...
  async function saveItem(item) {
    ...
    if (item.id)
      await api("menu", { method: "PUT", body: JSON.stringify(payload) });
    ...
    <div className="menu-editor-container fade-in">
      <div className="editor-header-main">
        <div>
          ...
          <p className="editor-subtitle">
            Manage restaurant #{restaurantId} menu items, images, and stock
            status.
          </p>
        </div>
      ...
      <div className="metrics-row">
        <div className="metric-card">
          ...
          <h3>{items.length}</h3>
          <p>Loaded from your restaurant database</p>
        </div>
        <div className="metric-card">
          <div className="metric-header primary-text">
        ...
        <div className="metric-card highlight-card">
          ...
          <p>Only in-stock items appear on the student menu.</p>
        </div>
      </div>
              ...
              <div className="row-left">
                ...
                <div className="item-details">
                  <div className="item-title-row">
                    ...
                    {item.tag && (
                      <span className="item-tag tag-green">{item.tag}</span>
                    )}
                    {!item.inStock && (
                      <span className="item-tag tag-red">STOCK OUT</span>
                    )}
                  </div>
          ...
          <div className="modal-content">
            ...
            <form className="modal-form" onSubmit={handleModalSubmit}>
              <div className="input-group">
                ...
                <div className="image-upload-row">
                  {formData.image ? (
                    ...
                    <div className="item-preview-empty">
                      <ImagePlus size={26} />
                    </div>
                  )}
                  <input
              ...
              <div className="stock-modal-row">
                ...
                <span>Uncheck this to hide the item from students.</span>
              </div>
