    ...
    try {
      await api("restaurants", {
        ...
        body: JSON.stringify({
          id: restaurantId,
          ...form,
          image_data: imageData || profileImage,
    ...
    try {
      await api("tickets", {
        ...
        body: JSON.stringify({
          ...
          email: currentUser?.email || "owner@qless.local",
          title,
          message,
        }),
      });
      e.target.reset();
      setTicketStatus(
        "Ticket submitted to database. Support will contact you shortly.",
      );
    } catch (err) {
      ...
      <div className="owner-header">
        <div>
          ...
          <p className="subtitle">
            Manage details for restaurant #{restaurantId}.
          </p>
        </div>
      </div>
      <div className="profile-grid">
        ...
        <form className="form-section slide-up delayed" onSubmit={handleTicket}>
          ...
          <p className="form-helper-text">
            Facing a technical issue? Let us know.
          </p>
          <div className="input-group">
