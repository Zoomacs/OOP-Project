      ...
      <div className="track-wrapper">
        ...
        <div className="track-hero">
          ...
          <div className="estimated-card">
            <p>ORDER TIME</p>
            <h2>
              {String(baseOrderData.time || new Date().toLocaleTimeString())
                .split(",")
                .pop()}
            </h2>
          </div>
        ...
        <div className="status-container">
          <div
            className={`status-step ${isPreparing || isReady || isDelivered ? "completed" : "active"}`}
          >
          ...
          <div
            className={`status-line ${isReady || isDelivered ? "filled" : ""}`}
          ></div>
          <div
            className={`status-step ${isReady ? "active" : isDelivered ? "completed" : ""}`}
          >
            <div className="step-icon">
              <Utensils size={28} />
            </div>
