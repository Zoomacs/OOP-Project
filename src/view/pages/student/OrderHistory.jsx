...
function OrderHistory({ page, isOwner = false }) {
  ...
  async function advanceStatus(orderId, currentStatus) {
    ...
    setOrders((prev) =>
      prev.map((o) =>
        o.id === orderId ? { ...o, status: next, state: next } : o,
      ),
    );
  }
      ...
      <div className="order-place">
        <div className="order-head">
          ...
          <p className="order-head-desc">
            {isOwner
              ? "Monitor, track, and update status logs."
            ...
            <div className="Order-card" key={order.id}>
              ...
              <div className="card-content">
                ...
                <div className="card-details">
                  ...
                  <p className="card-time">{order.time}</p>
                      ...
                      <button
                        ...
                        onClick={() => {
                          sessionStorage.setItem(
                            "lastOrder",
                            JSON.stringify({ id: order.id, time: order.time }),
                          );
                          navigate("/ordertrack");
                        }}
                      >
              ...
              {!isOwner && (
                <div className="card-points">
                  <p className="card-points">+10 Points</p>
                </div>
              )}
            </div>
          ))}
