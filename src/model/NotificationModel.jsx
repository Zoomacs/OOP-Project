...
export default class NotificationModel extends BaseModel {
  ...
  set is_read(v) {
    this.#is_read = this._boolInt(v, 0);
  }
  isUnread() {
  ...
  getDisplayName() {
    return this.#title || super.getDisplayName();
  }
  isValid() {
    return this.#user_id !== null && this.#title !== "";
  }
  toJSON() {
    return {
      ...super.toJSON(),
