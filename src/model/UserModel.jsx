...
export default class UserModel extends BaseModel {
  ...
  set identifier(value) {
    this.#identifier = this._string(value);
  }
  ...
  set role(value) {
    this.#role = this._string(value, "student").toLowerCase();
  }
  ...
  set status(value) {
    this.#status = this._string(value, "Active");
  }
  ...
  isValid() {
    return this.#identifier !== "" && this.#role !== "";
  }
  getDisplayName() {
    return this.#name || this.#identifier || super.getDisplayName();
  }
