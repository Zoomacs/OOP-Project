...
export default class TicketModel extends BaseModel {
  ...
  set message(v) {
    this.#message = this._string(v);
  }
  get reply() {
    return this.#reply;
  }
  set reply(v) {
    this.#reply = this._string(v);
  }
  get admin_reply() {
    return this.#reply;
  }
  ...
  isAnswered() {
    return this.#status.toLowerCase() === "answered" || this.#reply !== "";
  }
  getDisplayName() {
    return this.#subject || super.getDisplayName();
  }
  isValid() {
