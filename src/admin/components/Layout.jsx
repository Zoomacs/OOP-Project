...
const adminPages = [
  { to: "/admin", label: "Users Dashboard", icon: LayoutDashboard },
  { to: "/admin/users-management", label: "Users Management", icon: Users },
  { to: "/admin/orders-monitoring", label: "Orders Monitoring", icon: ClipboardList },
  { to: "/admin/payment-monitoring", label: "Payment Monitoring", icon: CreditCard },
  { to: "/admin/system-analytics", label: "System Analytics", icon: ChartNoAxesCombined },
  { to: "/admin/tickets", label: "Tickets", icon: Ticket }
];

const functions = [
  { to: "/admin/ban-student", label: "Ban Student", icon: Ban },
  { to: "/admin/add-restaurant", label: "Add Restaurant", icon: Store },
  { to: "/admin/remove-restaurant", label: "Remove Restaurant", icon: StoreIcon },
  { to: "/admin/add-admin", label: "Add Admin", icon: ShieldPlus },
  { to: "/admin/view-customers", label: "View Customers", icon: UserRoundSearch },
  { to: "/admin/view-transactions", label: "View Transactions", icon: ReceiptText },
  { to: "/admin/view-contact-tickets", label: "View Contact Tickets", icon: Ticket },
  { to: "/admin/reply-contact-ticket", label: "Reply Contact Ticket", icon: MessageCircleReply }
];
  ...
  return (
    <div className={isSidebarOpen ? "layout sidebar-open" : "layout"}>
      ...
      <aside className="sidebar">
        ...
        <div className="nav-title">Functions</div>
        {functions.map((item) => <SideLink key={item.to} item={item} onClick={closeSidebar} />)}
