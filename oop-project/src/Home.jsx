      ...
      <div className="container">
        ...
        <section className="hero">
          <div className="hero-content">
            ...
            <h1>Skip the line,<br /><span>Savor the time.</span></h1>
            <p>Order from any campus restaurant and get notified when your meal is ready. No queues, no hassle.</p>
            <div className="hero-btns">
              <a href="/order" className="btn btn-primary">Order Now <i className="fas fa-bolt"></i></a>
              <a href="/menu" className="btn btn-secondary">View Menu</a>
            </div>
          </div>
          <div className="hero-image">
            <img src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=800&q=80" alt="Delicious Food" />
        ...
        <section>
          <div className="section-header">
            ...
            <a href="/categories" className="see-all">See All <i className="fas fa-chevron-right"></i></a>
          </div>
        ...
        <section>
          <div className="section-header">
            <h2>Today's Hot Offers <span className="offers-badge">SAVINGS</span></h2>
          </div>
          ...
          <div className="offers-grid">
            {offers.map((offer) => (
              <div className="offer-card" key={offer.id}>
                ...
                <button className="heart-btn"><i className="fas fa-heart"></i></button>
                ...
                <div className="offer-info">
                  ...
                  <div className="offer-footer">
                    ...
                    <a href={`/claim/${offer.id}`} className="claim-btn">Claim Offer <i className="fas fa-arrow-right"></i></a>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section className="banner">
          <div className="banner-content">
            ...
            <p>Our map shows you the quickest route from your lecture hall to the dining hall. Never get lost on your way to lunch again.</p>
            <a href="/map" className="btn btn-white">Open Campus Map <i className="fas fa-map-marked-alt"></i></a>
          </div>
          <div className="banner-image">
            <img src="https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=800&q=80" alt="Campus Map Illustration" />
          </div>
        </section>
        ...
        <footer>
          <div>
            <div className="footer-logo">
              <svg viewBox="0 0 500 150" style={{ width: '80px', height: '40px' }}>
                <text x="0" y="110" style={{ fill: 'var(--text-color)', fontFamily: '"Playpen Sans", cursive', fontWeight: 800, fontSize: '110px' }}>
                  Q-<tspan style={{ fill: 'var(--primary-color)' }}>Less</tspan>
                </text>
              </svg>
            </div>
            <div className="footer-copy">© 2026 Q-Less University Dining. All rights reserved.</div>
          </div>
