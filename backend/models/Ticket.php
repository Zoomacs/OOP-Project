...
class Ticket extends DomainModel
{
    ...
    {
        $this->subject = $this->stringValue($value);
        return $this;
    }
    ...
    {
        $this->message = $this->stringValue($value);
        return $this;
    }
    ...
    {
        $this->reply = $this->stringValue($value);
        return $this;
    }
    ...
    {
        return strtolower($this->status) === 'answered' || $this->reply !== '';
    }
    public function getDisplayName()
    {
        return $this->subject ?: parent::getDisplayName();
    }
    ...
    {
        return ['id' => $this->id, 'user_id' => $this->user_id, 'subject' => $this->subject, 'title' => $this->subject, 'message' => $this->message, 'reply' => $this->reply, 'admin_reply' => $this->reply, 'status' => $this->status];
    }
}
