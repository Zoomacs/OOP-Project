...
class Staff extends Customer
{
    ...
    {
        return $this->getRestaurantId() ? '/restaurant-dashboard' : '/home';
    }
    public function canAccessOwner()
    {
        return (bool) $this->getRestaurantId();
    }
    ...
    {
        $this->discountRate = $this->numberValue($value);
        return $this;
    }
    public function toArray()
    {
        return array_merge(parent::toArray(), ['discount_rate' => $this->discountRate]);
    }
}
